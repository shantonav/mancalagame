...
import com.example.mancala.gamemancala.model.SystemError;
...
public class RestControllerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = {GameApiException.class})
    protected ResponseEntity<Object> handleGameApiException(
            final GameApiException ex){
        return new ResponseEntity(new  ApiError(SystemError.INPUT_DATA_ERROR.getErrorCode(),
                SystemError.INPUT_DATA_ERROR.getErrorMessage(),
